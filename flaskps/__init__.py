...
from flaskps.resources import (admin, api, assistance, base, instrument,
                               nucleus_map, responsable, school_year, student,
                               teacher, user, webconfig)
...
app.add_url_rule("/usuarios/new", 'user_create',
...
app.add_url_rule("/configuracion/editar", 'webconfig_edit',
                 webconfig.edit, methods=['POST'])
...
app.add_url_rule("/estudiantes/<student_id>/talleres",
                 'student_workshops', student.workshops)
app.add_url_rule("/estudiantes/inscribe/<student_id>", 'student_assign',
                 student.assign_workshop, methods=['POST', 'GET'])
app.add_url_rule("/estudiantes/<student_id>/responsables",
                 'student_responsables', student.responsables)
app.add_url_rule("/estudiantes/<student_id>/responsables/asignar",
                 'student_assign_responsable', student.assign_responsable, methods=['POST', 'GET'])
app.add_url_rule("/estudiantes/<student_id>/responsables/new",
                 "responsable_new", student.reponsable_new, methods=['POST', 'GET'])
app.add_url_rule("/estudiantes/<student_id>/asistencias",
                 "student_assistances", student.assistances)
...
app.add_url_rule("/docentes/desactivar/<teacher_id>",
                 'deactivate_teacher', teacher.deactivate, methods=['POST'])
app.add_url_rule("/docentes/activar/<teacher_id>",
                 'activate_teacher', teacher.activate, methods=['POST'])
app.add_url_rule("/docentes/new", 'teacher_new',
                 teacher.new, methods=['POST', 'GET'])
app.add_url_rule("/docentes/editar/<teacher_id>",
                 'teacher_edit', teacher.edit, methods=['POST', 'GET'])
app.add_url_rule("/docentes/<teacher_id>", 'teacher_profile', teacher.profile)
app.add_url_rule("/docentes/<teacher_id>/talleres",
                 'teacher_workshops', teacher.workshops)
app.add_url_rule("/docentes/inscribe/<teacher_id>", 'teacher_assign',
                 teacher.assign_workshop, methods=['POST', 'GET'])
app.add_url_rule("/docentes/asignar_nucleo/<teacher_id>",
                 'teacher_assign_nucleus', teacher.assign_nucleus, methods=['POST', 'GET'])


# API
app.add_url_rule('/api/docente/<docente_id>/ciclo/<ciclo_id>',
                 'cicle_workshops_teacher', api.cicle_workshops_teacher)
app.add_url_rule('/api/docente/<docente_id>/ciclo_taller/<ciclo_id>',
                 'cicle_workshops_of_teacher', api.cicle_workshops_of_teacher)
app.add_url_rule('/api/docente/<docente_id>/ciclo/<ciclo_id>/taller/<taller_id>/nucleo/<nucleo_id>',
                 'cicle_workshops_nucleus_of_teacher', api.cicle_workshops_nucleus_of_teacher)
app.add_url_rule('/api/estudiante/<estudiante_id>/ciclo/<ciclo_id>',
                 'cicle_workshops_student', api.cicle_workshops_student)
app.add_url_rule('/api/ciclo_lectivo/<ciclo_id>',
                 'cicle_workshops', api.cicle_workshops)
app.add_url_rule('/api/fechas/<ciclo_id>/<taller_id>/<nucleo_id>',
                 'workshop_dates', api.get_days_for_workshop_in_schoolyear)
app.add_url_rule('/api/nucleos/<ciclo_id>/<taller_id>',
                 'nucleus_courses', api.nucleus_of_teacher)


# SchoolYear
app.add_url_rule("/ciclo_lectivo/new", 'schoolyear_new',
                 school_year.new, methods=['POST', 'GET'])
app.add_url_rule("/ciclo_lectivo/assign_workshop", 'schoolyear_assign_workshop',
                 school_year.assign_workshop, methods=['POST', 'GET'])
...
app.add_url_rule("/asistencia/<schoolyear_id>/<workshop_id>/<nucleus_id>/<assistance_date>",
                 'assistance_register', assistance.register_assistance, methods=['POST', 'GET'])
